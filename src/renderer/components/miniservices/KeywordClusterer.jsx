                  ...
                  <div key={index} className="cluster-item">
                    <div className="cluster-header">
                      <div className="cluster-title">
                        ...
                        <span className="cluster-primary">
                          {cluster.primary}
                        </span>
                        ...
                        <ul className="related-list">
                          {cluster.related.map((rel, idx) => (
                            <li key={idx} className="related-item">
                              <span className="related-keyword">
                                {rel.keyword}
                              </span>
          ...
          <Card className="info-card">
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  Instead of creating separate pages for each keyword,
                  clustering helps you identify thematic groups that can be
                  covered in single, comprehensive pieces of content. This
                  approach is more efficient and user-friendly.
                </p>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="benefits-list">
                  <li>
                    <strong>Topic Authority:</strong> Create in-depth content
                    that ranks for multiple related terms
                  </li>
                  <li>
                    <strong>Internal Linking:</strong> Better site structure
                    with thematic content clusters
                  </li>
                  <li>
                    <strong>Semantic SEO:</strong> Help search engines
                    understand your content&apos;s context
                  </li>
                  <li>
                    <strong>Long-tail Targeting:</strong> Discover keyword
                    variations for better ranking opportunities
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Similarity Analysis:</strong> Keywords are compared
                    based on shared words and semantic meaning
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Quality Scoring:</strong> Each cluster gets a
                    quality score based on cohesion and relevance
                  </li>
                  <li>
                    <strong>Content Themes:</strong> Identifies the main topic
                    or theme of each cluster
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <div className="tips-grid">
                  <div className="tip-item">
                    <strong>Start Broad:</strong> Include variations of your
                    main keywords to discover natural groupings
                  </div>
                  <div className="tip-item">
                    <strong>Quality Over Quantity:</strong> Focus on
                    high-quality clusters (70+ score) for content creation
                  </div>
                  <div className="tip-item">
                    <strong>Content Planning:</strong> Use cluster names as
                    content pillars for your website structure
                  </div>
                </div>
              </div>
            </div>
