        ...
        <div className="analysis-section">
          ...
          <div className="metrics-grid">
            <div className="metric-item">
              ...
              <span className="metric-value">{results.averages.wordCount}</span>
            </div>
            <div className="metric-item">
            ...
            <div className="metric-item">
              ...
              <span className="metric-value">{results.averages.listCount}</span>
            </div>
          </div>
        </div>
          ...
          <div className="comparison-list">
            ...
            <div className="comparison-item">
              <div className="comp-metric">
                ...
                >
                  {getStatusBadge(results.comparison.headingCount.status).text}
                </div>
              </div>
              <div className="comp-details">
            ...
            <div className="comparison-item">
              <div className="comp-metric">
                ...
                >
                  {getStatusBadge(results.comparison.imageCount.status).text}
                </div>
              </div>
              <div className="comp-details">
