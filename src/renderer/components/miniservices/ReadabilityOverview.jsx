  ...
  return (
    ...
    >
      ...
      <div className="results-container">
        {results?.meta?.warnings?.map((warning, index) => (
            ...
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  ...
                  industry-standard formulas: Flesch Reading Ease,
                  Flesch-Kincaid, Gunning Fog, SMOG, Coleman-Liau, and Automated
                  Readability Index.
                </p>
              </div>
              ...
              <div className="info-section">
                ...
                <p>
                  Combines the Flesch Reading Ease (60% weight) with an average
                  of grade-level metrics (40% weight) to produce a single,
                  balanced readability score.
                </p>
              </div>
