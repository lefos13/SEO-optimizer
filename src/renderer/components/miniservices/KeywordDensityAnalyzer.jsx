                  ...
                  <div key={index} className="density-item">
                    <div className="density-header">
                      <span className="density-keyword">
                        ...
                        <span className="keyword-type-badge">
                          {result.type}
                        </span>
                      </span>
                      <span
                  ...
                  {results.recommendations.map((rec, index) => (
                    ...
                    >
                      ...
                      <div className="recommendation-content">
                        <div className="recommendation-keyword">
                          {rec.keyword}
                        </div>
            ...
            {results.distribution && (
              <Card className="distribution-card">
                ...
                <p className="card-description">
                  Shows how keywords are distributed across different sections
                  of your content.
                </p>
          ...
          <Card className="info-card">
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  Keyword density measures how frequently your target keywords
                  appear in your content relative to the total word count.
                  It&apos;s a crucial factor in on-page SEO that helps search
                  engines understand your content&apos;s relevance while
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>1-3% (Optimal):</strong> The sweet spot where
                    keywords appear naturally without being overused. This range
                    typically provides the best ranking potential.
                  </li>
                  <li>
                    <strong>&lt;1% (Underused):</strong> Keywords may not be
                    prominent enough for search engines to recognize topical
                    relevance. Consider increasing usage naturally.
                  </li>
                  <li>
                    <strong>&gt;3% (Overused):</strong> Risk of keyword stuffing
                    penalties. Search engines may view this as manipulative and
                    reduce rankings.
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    ...
                    counted as complete units rather than individual words,
                    providing more accurate density calculations.
                  </li>
                  <li>
                    <strong>Content Distribution:</strong> Analyzes keyword
                    placement across different content sections (introduction,
                    body, conclusion) for optimal user experience.
                  </li>
                  <li>
                    <strong>Position Tracking:</strong> Visual indicators show
                    exactly where keywords appear in your content, helping you
                    achieve natural distribution.
                  </li>
                  <li>
                    <strong>Smart Recommendations:</strong> Actionable
                    suggestions to optimize density based on current usage
              ...
              <div className="info-section">
                ...
                <div className="tips-grid">
                  <div className="tip-item">
                    <strong>Natural Integration:</strong> Use keywords in
                    headings, subheadings, and naturally within sentences
                  </div>
                  <div className="tip-item">
                    <strong>LSI Keywords:</strong> Include semantically related
                    terms to improve overall topical relevance
                  </div>
                  <div className="tip-item">
                    <strong>Content Length:</strong> Longer, comprehensive
                    content allows for more natural keyword distribution
                  </div>
                </div>
              </div>
            </div>
