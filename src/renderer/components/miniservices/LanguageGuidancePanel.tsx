...
interface SEOImpact {
  ...
  userEngagement: SEOMetric;
  mobileFriendliness: SEOMetric;
  voiceSearchOptimization: SEOMetric;
  featuredSnippetPotential: SEOMetric;
}
...
interface LanguageGuidanceResults {
...
const LanguageGuidancePanel: React.FC = () => {
  const [content, setContent] = useState('');
  const [language, setLanguage] = useState('en');
  const [results, setResults] = useState<LanguageGuidanceResults | null>(null);
    ...
    try {
      const result =
        (await window.electronAPI.readability.analyzeLanguageGuidance(trimmed, {
          language,
        })) as unknown as LanguageGuidanceResults;
      setResults(result);
      scrollToResults();
    } catch (err) {
      ...
      <Card className="summary-card" title="Content Analysis">
        <div className="content-analysis-summary">
          ...
          <div className="analysis-row">
            ...
            <span className="analysis-value">
              {results?.languageGuidance.contentAnalysis.overallReadability}
            </span>
          </div>
          <div className="analysis-row">
            <span className="analysis-label">Score:</span>
            <span className="analysis-value">
              {Math.round(results?.languageGuidance.contentAnalysis.score || 0)}
              /100
            </span>
          </div>
          <div className="analysis-row">
        ...
        <div className="seo-impact-grid">
          ...
          <div className="seo-metric">
            <div className="metric-header">
              ...
              >
                {results?.languageGuidance.seoImpact.mobileFriendliness.score}
              </span>
            </div>
            <div className="metric-status">
              {results?.languageGuidance.seoImpact.mobileFriendliness.status}
            </div>
            <div className="metric-reason">
              {results?.languageGuidance.seoImpact.mobileFriendliness.reason}
            </div>
          </div>
          ...
          <div className="seo-metric">
            <div className="metric-header">
              ...
              >
                {
                  results?.languageGuidance.seoImpact.featuredSnippetPotential
                    .score
                }
              </span>
            </div>
        ...
        results.languageGuidance.specificIssues.length > 0 && (
          <Card className="results-card" title="Specific Issues Found">
            <div className="issues-list">
              {results.languageGuidance.specificIssues.map((issue, index) => (
                <div
                  ...
                  {issue.examples && issue.examples.length > 0 && (
                    <div className="issue-examples">
                      ...
                      {issue.examples.map((example, exIdx) => (
                        <div key={`ex-${exIdx}`} className="example-item">
      ...
      <Card className="results-card" title="Actionable SEO Advice">
        <div className="advice-list">
          ...
          results.languageGuidance.actionableAdvice.length > 0 ? (
            results.languageGuidance.actionableAdvice.map((advice, index) => (
              <div
                ...
                (strength, index) => (
                  ...
                  >
                    ...
                    <div className="strength-content">
                      ...
                      <div className="strength-text">{strength.strength}</div>
    ...
    <Card className="info-card">
      <div className="info-content">
        ...
        <div className="info-section">
          ...
          <p>
            Unlike static checklists, this tool analyzes YOUR actual content to
            identify specific readability issues and their SEO impact. Get
            personalized, actionable advice based on your text.
          </p>
        </div>
        ...
        <div className="info-section">
          ...
          <ul className="info-list">
            ...
            <li>
              <strong>Specific Issues:</strong> Exact problems found in your
              content with examples and severity levels
            </li>
            <li>
              <strong>Actionable Advice:</strong> Prioritized recommendations
              with clear actions and expected SEO impact
            </li>
            <li>
        ...
        <div className="info-section">
          ...
          <p>All guidance is tailored for SEO optimization, considering:</p>
          <ul className="info-list">
        ...
        <div className="info-section">
          ...
          <p>
            Analysis adapts to English and Greek content patterns, providing
            language-specific SEO guidance based on regional search behaviors
  ...
  return (
    <MiniServiceContainer
      ...
      error={error}
      results={results}
      analyzeButtonText="Get Language Guidance"
