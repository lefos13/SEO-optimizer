    ...
    >
      <Card className="input-card">
        ...
        <div className="button-group">
          ...
          >
            {loading ? 'Generating...' : 'Generate LSI Keywords'}
          </button>
              ...
              <div className="stats-grid">
                ...
                <div className="stat-item">
                  <div className="stat-value">
                    {Math.round(results.summary.avgLSIScore)}
                  </div>
            ...
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  ...
                  that are semantically related to your main topic. They help
                  search engines understand the context and depth of your
                  content beyond just exact-match keywords.
                </p>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="benefits-list">
                  <li>
                    <strong>Enhanced Relevance:</strong> Demonstrate
                    comprehensive topic coverage to search engines
                  </li>
                  <li>
                    <strong>Improved Rankings:</strong> Help your content rank
                    for a broader range of related searches
                  </li>
                  <li>
                    <strong>Better User Experience:</strong> Create more
                    informative, valuable content for readers
                  </li>
                  <li>
                    <strong>Content Depth:</strong> Show expertise by covering
                    related concepts and terminology
                  </li>
                  <li>
                    <strong>Internal Linking:</strong> Natural opportunities to
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Content Parsing:</strong> Analyzes your text to
                    identify meaningful terms and concepts
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Relevance Scoring:</strong> Rates LSI terms based on
                    their contextual relationship to your topic
                  </li>
                  <li>
                    <strong>Frequency Analysis:</strong> Considers how often
                    terms appear to determine importance
                  </li>
                  <li>
              ...
              <div className="info-section">
                ...
                <div className="tips-grid">
                  <div className="tip-item">
                    <strong>Strategic Placement:</strong> Include LSI keywords
                    in headings, subheadings, and throughout the content body
                  </div>
                  <div className="tip-item">
                    <strong>Content Expansion:</strong> Use LSI terms to
                    identify topics for additional content creation
                  </div>
                  <div className="tip-item">
                    <strong>Voice Search Optimization:</strong> LSI keywords
                    often align with natural language queries
                  </div>
                </div>
              </div>
            </div>
