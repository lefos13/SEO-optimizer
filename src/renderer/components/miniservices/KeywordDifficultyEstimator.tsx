...
interface KeywordDifficultyResults {
  distribution: Distribution;
  estimates: DifficultyEstimate[];
  easiest: KeywordSummary[];
  hardest: KeywordSummary[];
}

const KeywordDifficultyEstimator: React.FC = () => {
  const [keywords, setKeywords] = useState<string>('');
  const [results, setResults] = useState<KeywordDifficultyResults | null>(null);
  ...
  return (
    <MiniServiceContainer<KeywordDifficultyResults>
