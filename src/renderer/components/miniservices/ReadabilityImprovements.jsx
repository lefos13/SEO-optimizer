          ...
          <div className="metrics-grid">
            <div className="metric-item">
              ...
              <span className="metric-value">
                {typeof results.totals.words === 'object'
                  ? results.totals.words.length || 0
                  : results.totals.words || 0}
              </span>
            </div>
            <div className="metric-item">
              <span className="metric-label">Sentences:</span>
              <span className="metric-value">
                {typeof results.totals.sentences === 'object'
                  ? results.totals.sentences.length || 0
                  : results.totals.sentences || 0}
              </span>
            </div>
            <div className="metric-item">
              <span className="metric-label">Paragraphs:</span>
              <span className="metric-value">
                {typeof results.totals.paragraphs === 'object'
                  ? results.totals.paragraphs.length || 0
                  : results.totals.paragraphs || 0}
              </span>
            </div>
            <div className="metric-item">
              <span className="metric-label">Avg Sentence Length:</span>
              <span className="metric-value">
                {typeof results.totals.averageSentenceLength === 'object'
                  ? results.totals.averageSentenceLength.length || 0
                  : results.totals.averageSentenceLength || 0}
              </span>
            </div>
            <div className="metric-item">
              ...
              <span className="metric-value">
                {typeof results.totals.complexWordRatio === 'number'
                  ...
                  : typeof results.totals.complexWordRatio === 'object'
                    ? `${((results.totals.complexWordRatio.length || 0) * 100).toFixed(1)}%`
                    : 'N/A'}
              </span>
            </div>
          </div>
