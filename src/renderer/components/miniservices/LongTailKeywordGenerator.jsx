      ...
      <Card className="input-card">
        ...
        <div className="button-group">
          <button
            ...
            disabled={loading || getWordCount(content) < 100}
            ...
            <Card className="results-card">
              ...
              {getSuggestionsToShow().length > 0 ? (
                ...
                <div className="empty-state">
                  ...
                  <p>
                    No {activeIntent !== 'all' ? activeIntent : ''} keywords
                    found. Try adjusting your content or seed keywords.
                  </p>
                </div>
              )}
            </Card>
            ...
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  ...
                  (typically 3-5 words) that users type when they&apos;re
                  further along in the buying cycle or have very specific
                  information needs. They represent the &quot;long tail&quot; of
                  search demand.
                </p>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="benefits-list">
                  <li>
                    <strong>Lower Competition:</strong> Less websites competing
                    for these specific terms
                  </li>
                  <li>
                    <strong>Higher Intent:</strong> Users searching with
                    long-tail queries often know exactly what they want
                  </li>
                  <li>
                    <strong>Better Conversion Rates:</strong> More qualified
                    traffic that&apos;s ready to take action
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Niche Targeting:</strong> Reach highly specific
                    audience segments with precise needs
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Informational:</strong> Educational queries like
                    &quot;how to&quot;, &quot;guide&quot;, &quot;tutorial&quot;
                    - users seeking knowledge and learning resources
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Navigational:</strong> Brand or site-specific
                    searches like &quot;login&quot;, &quot;app&quot;,
                    &quot;software&quot; - users looking for a specific website
                    or service
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Content Analysis:</strong> Extracts meaningful
                    phrases from your existing content
                  </li>
                  <li>
                    <strong>Seed Keyword Expansion:</strong> Uses your main
                    keywords as starting points for expansion
                  </li>
                  <li>
                    <strong>Scoring Algorithm:</strong> Rates suggestions based
                    on relevance, frequency, and specificity
                  </li>
                  <li>
                    <strong>Intent Classification:</strong> Automatically
              ...
              <div className="info-section">
                ...
                <div className="tips-grid">
                  <div className="tip-item">
                    <strong>Content Depth:</strong> Create comprehensive content
                    that naturally incorporates long-tail variations
                  </div>
                  <div className="tip-item">
                    <strong>Question-Based Content:</strong> Answer specific
                    questions users are asking in search
                  </div>
                  <div className="tip-item">
                    <strong>Topic Clusters:</strong> Use long-tail keywords to
