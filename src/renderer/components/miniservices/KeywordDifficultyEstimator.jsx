          ...
          <Card className="info-card">
            <div className="info-content">
              ...
              <div className="info-section">
                ...
                <p>
                  Keyword difficulty estimates how challenging it would be to
                  rank for a specific term in search engine results. It
                  considers factors like competition, search volume, and the
                  effort required to achieve top rankings.
                </p>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Easy (0-30):</strong> Low competition keywords,
                    often long-tail phrases, good for beginners and new websites
                  </li>
                  <li>
                    <strong>Medium (30-60):</strong> Moderate competition,
                    requires quality content and some SEO effort
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Very Hard (80-100):</strong> Extremely competitive
                    terms dominated by large, authoritative websites
                  </li>
                </ul>
              </div>
              ...
              <div className="info-section">
                ...
                <ul className="info-list">
                  <li>
                    <strong>Keyword Length:</strong> Shorter keywords are
                    generally more competitive
                  </li>
                  <li>
                    <strong>Commercial Intent:</strong> Purchase-related terms
                    often have higher difficulty
                  </li>
                  <li>
                    <strong>Generic Terms:</strong> Broad, popular words
                    increase competition
                  </li>
                  <li>
                    <strong>Question-Based:</strong> &quot;How-to&quot; and
                    question keywords tend to be easier
                  </li>
                  <li>
              ...
              <div className="info-section">
                ...
                <div className="tips-grid">
                  <div className="tip-item">
                    <strong>Content Planning:</strong> Start with easier
                    keywords to build momentum and authority
                  </div>
                  <div className="tip-item">
                  ...
                  <div className="tip-item">
                    <strong>Long-term Strategy:</strong> Use difficulty scores
                    to plan content roadmaps and growth targets
                  </div>
                </div>
              </div>
            </div>
