...
const BeforeAfterComparison = ({ beforeAnalysis, afterAnalysis }) => {
  ...
  const calculateChange = (before, after) => {
    ...
    const percentChange = before !== 0 ? ((diff / before) * 100).toFixed(1) : 0;
          ...
          <div className="summary-stat">
            ...
            <div className="stat-content">
              ...
              <div className="stat-comparison">
                ...
                <span
                  className={`stat-change ${afterAnalysis.passedRules - beforeAnalysis.passedRules > 0 ? 'positive' : ''}`}
                >
                  (
                  {afterAnalysis.passedRules - beforeAnalysis.passedRules > 0
                    ? '+'
                    : ''}
                  {afterAnalysis.passedRules - beforeAnalysis.passedRules})
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="summary-stat">
            ...
            <div className="stat-content">
              ...
              <div className="stat-comparison">
                ...
                <span
                  className={`stat-change ${beforeAnalysis.failedRules - afterAnalysis.failedRules > 0 ? 'positive' : ''}`}
                >
                  (
                  {afterAnalysis.failedRules - beforeAnalysis.failedRules > 0
                    ? '+'
                    : ''}
                  {afterAnalysis.failedRules - beforeAnalysis.failedRules})
                </span>
              </div>
            </div>
          </div>
...
BeforeAfterComparison.propTypes = {
  beforeAnalysis: PropTypes.shape({
