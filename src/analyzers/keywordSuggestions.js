 ...
 * @returns {boolean} True if word appears to be code
 */
function isCodeWord(word) {
 ...
 * @param {string} word - Word to check
 * @returns {boolean} True if word appears to be real language
 */
function isRealLanguageWord(word) {
 ...
 * @returns {Map<string, number>} Map of phrases and their frequencies
 */
 ...
 * @param {number} frequency - How many times the word appears
 * @param {number} totalWords - Total words in text
 * @param {number} length - Word length
 * @returns {number} Relevance score (0-100)
 */
function calculateRelevanceScore(frequency, totalWords, length) {
 ...
 * @param {string} _language - Content language ('en' or 'el') - reserved for future language-specific filtering
 * @returns {Array<Object>} Array of keyword suggestions with scores
 */
function suggestKeywords(html, maxSuggestions = 10, _language) {
  try {
 ...
 * @param {number} maxSuggestions - Max suggestions
 * @param {string} _language - Language code - reserved for future use
 * @returns {Array<string>} Array of keyword strings
 */
function getSuggestionStrings(html, maxSuggestions = 10, _language) {
