...
export const STOPWORDS = new Set([
  ...
  'does', 'down', 'during', 'each', 'few', 'for', 'from', 'further', 'had', 'has', 'have', 'having', 'he', 'her',
  'here', 'hers', 'herself', 'him', 'himself', 'his', 'how', 'i', 'if', 'in', 'into', 'is', 'it', 'its', 'itself',
  'just', 'me', 'might', 'more', 'most', 'my', 'myself', 'no', 'nor', 'not', 'of', 'off', 'on', 'once', 'only',
  ...
  'will', 'could', 'should', 'it', 'your', 'you', 'its', 'our',

  // Greek stopwords
  'ο', 'η', 'το', 'οι', 'τα', 'την', 'των', 'τον', 'του', 'της', 'και', 'που', 'να', 'για', 'είναι', 'σε',
  'με', 'αν', 'από', 'μόνο', 'αλλά', 'δεν', 'όχι', 'ή', 'ως', 'αυτό', 'αυτή', 'αυτοί', 'αυτές', 'αυτά',
  'πολύ', 'πολλά', 'λίγο', 'λίγα', 'κάτι', 'άλλο', 'άλλα', 'άλλη', 'άλλες', 'κάποιος', 'κάποια', 'κάποιο',
  'κάποιοι', 'κάποιες', 'ποιος', 'ποια', 'ποιο', 'ποιοι', 'ποιες', 'πώς', 'πού', 'πότε', 'γιατί', 'ποσο',
  'ποσα', 'είμαι', 'είσαι', 'εστε', 'ειμαστε', 'ειστε', 'εινε', 'ημουν', 'ησουν', 'ημασταν', 'ησασταν',
  'θα', 'ας',
]);
    ...
    const suggestions = Array.from(allKeywords.entries())
      .map(([keyword, frequency]) => {
        ...
        return {
          ...
          type: (keyword.includes(' ') ? 'phrase' : 'word') as 'word' | 'phrase',
        };
      })
